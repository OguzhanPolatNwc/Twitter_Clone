    ...
    public class UserService
    {
            ...
            var body = @$"
                <html>
                    ...
                    <body>
                        ...
                        <p>Click on the link below to activate your membership.</p>
                        <a href=""https://localhost:7269/Auth/Login?email={user.Email}&activationKey={userRegister.ActivationKey}"">Aktive Et</a>
                    </body>
                </html>
            ";

            this.emailService.Send(user.Email, "Twitter Clone: Membership Activation", body);
        ...
        public async Task<UserDto> ForgotPassword(UserDto user)
        {
            ...
            if (user2 != null)
            {
                ...
                this.emailService.Send(user.Email, "Twitter Clone: Reset Membership Password", body);
